    				        ...
    				        <tbody>
    				            <tr style="height: 100%;">
    				                <td colspan="6" style="background-image: url('<?php echo $baris->Img1 ?>'); background-repeat: no-repeat; background-size: cover; background-position: center center; position: relative;">
                                        ...
                                        <div style="position: absolute; width: 350px; bottom: 230px; right: 40px; border-radius: 0px; text-align: center; display: flex; align-items: center; justify-content: center;">
                                            <div style="position: absolute; width: 100%; bottom: 0px;">
                                                <?php 
                                                    $agen = $baris->IdAgen;
                                                    $agenco = $baris->IdAgenCo;
                                                    if (trim($agenco) == '0') {
                                                        echo '<img src="'. $baris->Photo .'" style="margin-bottom: 30px; width: 80%; height: auto; border: 0px solid rgb(255,242,0); border-radius: 1000%;" />';
                                                    } elseif (trim($agenco) == trim($agen))  {
                                                        echo '<img src="'. $baris->Photo .'" style="margin-bottom: 30px; width: 80%; height: auto; border: 0px solid rgb(255,242,0); border-radius: 1000%;" />';
                                                    } else {
                                                        echo '<img src="'. $baris->Photo .'" style="margin-bottom: 100px; width: 45%; height: auto; border: 0px solid rgb(255,242,0); border-radius: 1000%;" />';
                                                        echo '<img src="'. $baris->PhotoCo .'" style="margin-bottom: 100px; width: 45%; height: auto; border: 0px solid rgb(255,242,0); border-radius: 1000%;" />';
                                                    }
                                                    
                                                    
                                                ?>
                                            </div>
                                            <div style="background: rgb(255,242,0); position: absolute; width: 100%; bottom: 0px; text-align: center;">
                                                <?php 
                                                    $telp = $baris->NoTelpTemp;
                                                    $nama = $baris->NamaTemp; 
                                                    $telpco = $baris->NoTelpTempCo;
                                                    $namaco = $baris->NamaTempCo;
                                                    $agen = $baris->IdAgen;
                                                    $agenco = $baris->IdAgenCo;
                                                    if (trim($agenco) == '0') {
                                                        if (trim($nama) !== '0') {
                                                            echo '<h1 style="color: rgb(51,3,118); font-size: 250%; font-weight: 1000; margin: 5px; line-height: 1;">' . $baris->NamaTemp . '</h1>';
                                                        }
                                                        if (trim($telp) !== '0') {
                                                            echo '
                                                                <div style="display: flex; align-items: center; justify-content: center;">
                                                                    <i class="fab fa-whatsapp" style="font-size: 24px; color: black; margin: 5px;"></i>
                                                                    <h1 style="color: rgb(51,3,118); font-size: 150%; margin: 5px; margin-bottom: 10px; line-height: 1;">' . $baris->NoTelpTemp . '</h1>
                                                                </div>';
                                                        }
                                                    } elseif (trim($agenco) == trim($agen))  {
                                                        if (trim($nama) !== '0') {
                                                        ...
                                                        if (trim($telp) !== '0') {
                                                            echo '
                                                                <div style="display: flex; align-items: center; justify-content: center;">
                                                                    <i class="fab fa-whatsapp" style="font-size: 24px; color: black; margin: 5px; margin-bottom: 10px;"></i>
                                                                    <h1 style="color: rgb(51,3,118); font-size: 150%; margin: 5px; margin-bottom: 10px; line-height: 1;">' . $baris->NoTelpTemp . '</h1>
                                                                </div>';
                                                        }
                                                    } else {
                                                        echo '<h1 style="color: rgb(51,3,118); font-size: 250%; font-weight: 1000; margin: 5px; line-height: 1;">' . $baris->NamaTemp . ' - '. $baris->NamaTempCo .'</h1>';
                                                        echo '
                                                            <div style="display: flex; align-items: center; justify-content: center;">
                                                                <i class="fab fa-whatsapp" style="font-size: 24px; color: black; margin: 5px;"></i>
                                                                <h1 style="color: rgb(51,3,118); font-size: 150%; margin: 5px; line-height: 1;">' . $baris->NoTelpTemp . '</h1>
                                                            </div>
                                                            <div style="display: flex; align-items: center; justify-content: center;">
                                                                <i class="fab fa-whatsapp" style="font-size: 24px; color: black; margin: 5px;"></i>
                                                                <h1 style="color: rgb(51,3,118); font-size: 150%; margin: 5px; line-height: 1;">' . $baris->NoTelpTempCo . '</h1>
                                                            </div>';
                                                    }
                                        ...
                                        <div style="background: rgb(255,242,0); position: absolute; height: 200px; width: 100%; bottom: 0px; left: 0px;">
                                            <div style="background: rgb(255,242,0); position: absolute; height: 200px; width: 6%; bottom: 0px; left: 0px;border-radius: 0px; display: flex; align-items: center; justify-content: center; justify-content: space-between; box-sizing: border-box; padding: 10px;">
                                                <div style="width: 100%;">
                                                    <?php 
                                                        $agen = $baris->IdAgen;
                                                        $agenco = $baris->IdAgenCo;
                                                        if (trim($agenco) == '0') {
                                                            echo '<h1 style="color: rgb(0,0,0, 0.5); font-size: 150%; margin: 0px; line-height: 1;">'. $baris -> KodeAgen .'</h1>';
                                                        } elseif (trim($agenco) == trim($agen))  {
                                                            echo '<h1 style="color: rgb(0,0,0, 0.5); font-size: 150%; margin: 0px; line-height: 1;">'. $baris -> KodeAgen .'</h1>';
                                                        } else {
                                                            echo '<h1 style="color: rgb(0,0,0, 0.5); font-size: 150%; margin: 0px; line-height: 1;">'. $baris -> KodeAgen .'</h1>';
                                                            echo '<h1 style="color: rgb(0,0,0, 0.5); font-size: 150%; margin: 0px; line-height: 1;">'. $baris -> KodeAgenCo .'</h1>';
                                                        }
                                            ...
                                            <div style="background: rgb(255,242,0,0); position: absolute; height: 200px; width: 35%; bottom: 0px; left: 45%;border-radius: 0px; display: flex; align-items: flex-end; justify-content: space-between; box-sizing: border-box; padding: 10px;">
                                                <div style="width: 100%;">
                                                    <?php 
                                                        $rh = $baris->RangeHarga;
                                                ...
                                                <div style="width: 100%; text-align: right; margin-right: 5px">
                                                    <?php $kondisi = $baris->Kondisi;
                                                        if ($kondisi == 'Jual') {
                                                            ...
                                                            echo '
                                                                <h1 style="color: rgb(51,3,118); font-size: 350%; font-weight: 1000; margin: 0px;">SEWA ' . strtoupper($baris->JenisProperti) . '</h1>';
                                                        } elseif ($kondisi == 'Jual/Sewa') {
                                                            echo '
                                                                <h1 style="color: rgb(51,3,118); font-size: 350%; font-weight: 1000; margin: 0px;">JUAL/SEWA ' . strtoupper($baris->JenisProperti) . '</h1>';
                                                        } else {
                                                        }
                                                    ?>
                                                    <h1 style=" color: rgb(51,3,118); font-size: 170%; margin: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo strtoupper($baris -> AlamatTemplate) ?></h1>
                                                        ...
                                                        <?php $kondisi = $baris->Kondisi;
                                                            if ($kondisi == 'Jual') {
                                                                ...
                                                                if ($jenisproperti == 'Tanah') {
                                                                    echo '
                                                                        <div style="display: inline-block; background: rgb(255,242,0); border: 2px solid rgb(51,3,118);">
                                                                            <h1 style="color: rgb(51,3,118); font-size: 150%; margin: 5px;">Rp. ' . formatHargaSewaBlank($hargasewa) . ' / Thn</h1>
                                                                        </div>';
                                                                } else {
                                                                    echo '
                                                                        <div style="display: inline-block; background: rgb(255,242,0); border: 2px solid rgb(51,3,118);">
                                                                            <h1 style="color: rgb(51,3,118); font-size: 150%; margin: 5px;">Rp. ' . formatHargaSewaBlank($hargasewa) . '</h1>
                                                                        </div>';
                                                                }
                                                            } elseif ($kondisi == 'Jual/Sewa') {
                                                                $tipeharga = $baris->TipeHarga;
